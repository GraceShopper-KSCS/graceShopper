...
const { Product, Category, db } = require('../db/models')
...
describe('Routes', () => {
  ...
  describe('/books', () => {
      ...
      it('sends all books', () => {
        return agent
          ...
          .then((res) => {
            ...
            expect(res.body.some(book => book.title === 'HTML and CSS: Design and Build Websites')).to.equal(true)
    ...
    describe('GET /categories', () => {
      ...
      it('sends all the categories', async () => {
        ...
        await agent
          ...
          .then((res) => {
            ...
            expect(res.body.some(category => category.name === 'HTML')).to.equal(true)
